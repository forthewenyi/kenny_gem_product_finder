    ...
    >
      ...
      {isOpen && (
        <div className="absolute top-full left-0 pt-2 z-50">
          <div className="bg-white shadow-xl rounded-xl border border-gray-200 py-1.5 min-w-[180px] max-w-[280px] w-max animate-slideDown">
          {isLoading && (
              ...
              {data.items.map((item: PopularSearchItem, idx: number) => (
                <li key={idx}>
                  <button
                    ...
                    className="w-full text-left px-5 py-2.5 text-[11px] hover:bg-[#f8f8f8] transition-colors group"
                  >
